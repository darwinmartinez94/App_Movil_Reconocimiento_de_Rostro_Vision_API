package com.uth.reconocimiento_de_rostro;
...
import com.uth.reconocimiento_de_rostro.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void navegarProcesamiento(String tipoFoto) {
        ...
        navController.navigate(R.id.nav_reconocimiento_rostro, bundle);
    }
